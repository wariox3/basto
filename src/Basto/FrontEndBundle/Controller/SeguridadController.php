...
class SeguridadController extends Controller
{
    public function loginAction()
    {
        ...
        return $this->render(
            'BastoFrontEndBundle:Seguridad:login.html.twig',
            array(
    ...
    public function registroAction()
    {
        ...
        if ($request->getMethod() == 'POST') {            
            ...
            $arUsuario = new \Basto\FrontEndBundle\Entity\User();            
        ...
        return $this->render('BastoFrontEndBundle:Seguridad:registro.html.twig');
    }
